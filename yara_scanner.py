#!/usr/bin/env python
# yara_scanner
# usage: python yara_scanner.py -y <yara_rule_dst> [-s <scan_files_dir> (if not provided, current dir is scanned)]
...
class YaraClass:
    ...
    def __init__(self, arg_yara_dir, arg_scan_dir, arg_verbose):
        ...
        try:
            ...
            self.scan_dir = raw_input("Enter the directory you wish to scan...\n")
            self.yara_dir = "clamav.yara"
